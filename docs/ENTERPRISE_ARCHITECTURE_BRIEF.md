...
> **Version:** 2.20.0 • 100% Air-Gapped / Zero Telemetry Guarantee
...
1. Download the standalone Windows executable:  
   `evolve-ai-enterprise-portable-2.20.0-win32-x64.exe` (74.7 MB) from `https://www.evolveminds.com.au/products/evolve-ai/download/`.
