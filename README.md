# CodeForge AI — Context-Aware AI Coding Assistant for VS Code

**CodeForge AI** brings powerful AI code assistance directly into your editor. It works with **Ollama** (local/offline), **Anthropic Claude**, **OpenAI-compatible APIs**, and **Hugging Face** — so you choose where your code goes.
...
2. **Choose your AI provider**:
   ...
   - For **cloud AI**: Run `CodeForge AI: Switch AI Provider` from the command palette, select your provider, and enter your API key when prompted
...
```bash
# Using Azure CLI
az ad sp create-for-rbac --name "CodeForge-AI" --role "Reader" \
...
**Q: Does CodeForge AI work with LM Studio / llama.cpp / Jan?**
...
A: Automatically. When you open a workspace, CodeForge AI scans for marker files (e.g., `Dockerfile` for Docker, `manage.py` for Django). Matching plugins activate silently and start injecting domain knowledge into every AI interaction. The status bar shows active plugins.
...
CodeForge AI uses a plugin architecture that makes adding new stack support straightforward.
